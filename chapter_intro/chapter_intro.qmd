...
![Gapminder](chapter_intro_files/figure-html/ex_gganimate.gif)
...
1. 첫 번째 줄만 실행하면 무슨 일이 일어나는지 확인하시오. (객체 생성)
...
![Learning R](chapter_intro_files/figure-html/learning_path.png){width=65%}
